...
subzone_df <- read.csv("starting_point_final.csv")
hospital_polyclinic_df <- read_excel("SG Public Hospitals & Polyclinics.xlsx")
```
...
write.csv(SZ_HospPoly_df, "heuristic_distance.csv", row.names = FALSE)
...
write.csv(SZ_HospPoly_top5_df, "top5_healthcare.csv", row.names = FALSE)
```
