...
# Filter the dataset to include rows 1 to 575 only, planning areas from Ang Mo Kio to Hougang.
df = df.iloc[0:575]
...
# Save results to CSV
output_path = "/Users/paridhiagarwal/dse3101-LTAProject/healthcare_query1.csv"
