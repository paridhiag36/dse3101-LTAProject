...
# Filter the dataset to include rows 1081 to the end, planning areas from River Valley to Yishun
df = df.iloc[1080:]
...
# Save results to CSV
output_path = "/Users/paridhiagarwal/dse3101-LTAProject/healthcare_query3.csv"
